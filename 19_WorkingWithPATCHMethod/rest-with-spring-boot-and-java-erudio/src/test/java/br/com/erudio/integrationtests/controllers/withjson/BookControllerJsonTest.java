...
class BookControllerJsonTest /* extends AbstractIntegrationTest */ {
    ...
    void findAllTest() throws JsonProcessingException {
        ...
        // Lê o JSON como árvore de nós para pegar a lista "author" diretamente
        com.fasterxml.jackson.databind.JsonNode rootNode = objectMapper.readTree(content);
        com.fasterxml.jackson.databind.JsonNode authorNode = rootNode.path("_embedded").path("author");

        // Converte o nó "author" usando o TypeReference que já existe no seu projeto
        ...
        assertEquals(54.0, bookOne.getPrice()); // Valor corrigido de acordo com o seu JSON


        // ================= SEGUNDO LIVRO =================
        BookDTO foundBookFive = books.get(9);
        ...
        // AJUSTADO PARA CORRESPONDER AO SEU JSON REAL:
        assertEquals("O verdadeiro valor de TI", foundBookFive.getTitle());
        assertEquals("Richard Hunter e George Westerman", foundBookFive.getAuthor());
        assertEquals(95.0, foundBookFive.getPrice());
    }
